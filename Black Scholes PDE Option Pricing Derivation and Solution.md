...
The stock return is <img src=https://latex.codecogs.com/svg.latex?\frac{dS_t}{S_t}=\mu dt+\sigma dB_t/>, $B_t$ is a Brownian motion,$\iff dS_t= \mu S_tdt+\sigma S_tdB_t\quad(1)$;
